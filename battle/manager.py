"""BattleManager — 每日戰鬥實例 OCR + click 流程。

封裝 swipe / screenshot / click_text / find_battle_instance / handle_battle /
execute_all_battles。讀取單一 device + easyocr.Reader 即可運作。
"""
...
class BattleManager:
    ...
    def find_battle_instance(self, battle_name: str, check: bool = False) -> bool:
        ...
        if check:
            cropped_img = img[center[1] - 40:center[1] + 40,
                              center[0] - 40:center[0] + 30]
