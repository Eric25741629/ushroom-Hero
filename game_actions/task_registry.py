...
_TASKS: tuple[TaskDefinition, ...] = (
    ...
    _task("main_tasks", "所有日常任務", 150, ws_display_name="每日任務", pipeline_label="所有日常任務", skip=("所有日常任務",), completion=_MISSION, needs_main_page=True, time_window=(20, 23), tags=_DIRECT_SKIP),
    ...
    _task("farm", "農場任務", 50, pipeline_label="農場任務", skip=("農場任務",), conditional_skip=True, completion=_FARM_SEED, needs_main_page=True, tags=_DIRECT_SKIP),
