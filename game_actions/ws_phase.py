...
def _run_device(ip: str, cfg: dict, progress=None, *,
    ...
    kwargs = dict(
        ...
        lamp_daily_target=_cfg_int(cfg, "lamp_daily_target", 0),
        lamp_weekend_target=_cfg_int(cfg, "lamp_weekend_target", 0),
        ...
        seven_login_enabled=bool(cfg.get("seven_login_enabled", False)),
