# =====================================================================
# DEPRECATED — V1 神燈（monolithic Open_gold_paddle_ocr）
#
...
# V1 互動流程（open_the_gold / process_wanted_combo / execute_upgrade_sequence
# + __main__ CLI）已於 2026-06-21 移除；本檔現僅保留共用 OCR/解析/ROI helper 與
# 比較邏輯（compare_skill_pairs 等），供 tools/verify_lamp_via_playwright.py 使用。
# 請勿在此加新功能；修 bug 一律導向 V2。
# =====================================================================
import device as D
import time
import numpy as np
