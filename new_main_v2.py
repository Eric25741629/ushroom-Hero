        ...
        while (1):
            try:
                ...
                if get_stage_with_check(d, ip, Cnn_model, easyocr_reader) == "主頁面" :
                    ...
                    oracle(d, easyocr_reader, ip=ip, clf=clf, rl_recorder=rl_recorder, Cnn_model=Cnn_model, max_duration_minutes=mining_duration_min)
                ...
                if ip == "emulator-5556" and stage == "銝駁???" and (now_local.tm_wday in (5, 6)) and (now_local.tm_hour == 20):
...
def ensure_push_server_started():
